...
UniTEAPwn is a utility designed to work with Unitree robot firmware UPK files. It can decrypt existing UPK packages to extract their contents, as well as create new UPK files from tar archives or folders.
...
- **Batch processing**: Process multiple UPK files at once
- **Flexible extraction options**: Choose where to extract files (parent or subfolder)
